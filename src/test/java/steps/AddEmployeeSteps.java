...
public class AddEmployeeSteps extends CommonMethods {
    ...
    public void user_adds_multiple_employees_and_verify_they_are_added_successfully(DataTable dataTable) throws InterruptedException {
        ...
        for (Map<String, String> employee:employeeNames
           ...
           /* if(employeeList.personalDetailsTextBox.isDisplayed()){
                System.out.println("New employee is added");
            }else{
                System.out.println("Employee was not added");
            }  */

            /*   One more scenario to verify-
            to get ID from created new employee ID field and use it in search by ID function.
            But I can not get text from the field of created employee ID. Manually this scenario works */

            String valueID = employeeList.empIDcreated.getAttribute("value");
            click(employeeList.employeeListTab);
            sendText(employeeList.empSearchIdField,valueID);
            click(employeeList.searchButton);
            String verifyIDvalue = employeeList.afterAddEmpAppearedID.getText();
            Assert.assertEquals(valueID,verifyIDvalue);
