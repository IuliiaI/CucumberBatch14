...
public class DashboardSteps extends CommonMethods {
    ...
    public void user_verify_all_the_dashboard_tabs(DataTable dataTable) {
        List<String> expectedTabs = dataTable.asList();//this list is coming from feature file

        List<String> actualTabs = new ArrayList<>();//this list is coming from Dashboard Page
